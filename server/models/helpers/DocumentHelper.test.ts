...
describe("DocumentHelper", () => {
    ...
    describe("toHTML", () => {
        ...
        it("should render diff classes when changes provided", async () => {
            ...
            const changeset = ChangesetHelper.getChangeset(doc2.content, doc1.content);
...
| Long        | Table       |`,
    ...
    describe("toMarkdown", () => {
        ...
        it("should export code fences inside table cells on a single line", async () => {
            ...
            expect(result).toContain("```abap<br>a \\| b<br>c \\\\ d<br>line 2<br>```");
        ...
        it("should export notice blocks inside table cells on a single line", async () => {
            ...
            expect(result).toContain(":::warning<br>First \\| line<br><br>Second line<br><br>:::");
