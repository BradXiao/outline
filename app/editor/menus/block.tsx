...
export default function blockMenuItems(
  ...
  const items = [
    ...
    },
    {
      ...
      icon: <WarningIcon />,
      keywords: "notice card warning caution",
      attrs: { style: "warning" },
    },
    {
      name: "container_notice",
    ...
    {
      name: "container_notice",
      title: t("Question notice"),
      icon: <QuestionMarkIcon />,
      keywords: "notice card question help faq",
      attrs: { style: "question" },
    },
    {
      name: "container_notice",
      title: t("Error notice"),
      icon: <CrossIcon />,
      keywords: "notice card error danger",
      attrs: { style: "error" },
    },
    {
      name: "separator",
