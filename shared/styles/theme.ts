...
const buildBaseTheme = (input: Partial<Colors>) => {
  ...
  return {
    ...
    codeComment: "#008000",
    codePunctuation: "#000000",
    codeNumber: "#098658",
    codeProperty: "#0E93C5",
    codeTag: "#800000",
    codeClassName: "#0e93c5",
    codeString: "#a31515",
    codeSelector: "#800000",
    codeAttrName: "#e50000",
    ...
    codeKeyword: "#0000FF",
    codeFunction: "#314cd6",
    codeStatement: "#0000FF",
    codePlaceholder: "#0E93C5",
    codeInserted: "#098658",
    codeImportant: "#e90e90",
    codeConstant: "#0070C1",
    codeParameter: "#0E93C5",
    codeOperator: "#000000",
    noticeInfoBackground: colors.brand.blue,
    noticeInfoText: colors.almostBlack,
    noticeTipBackground: colors.brand.purple,
    noticeTipText: colors.almostBlack,
    noticeWarningBackground: colors.brand.yellow,
    noticeWarningText: colors.almostBlack,
    noticeSuccessBackground: colors.brand.green,
    noticeSuccessText: colors.almostBlack,
    noticeQuestionBackground: colors.brand.marine,
    noticeQuestionText: colors.almostBlack,
    noticeErrorBackground: colors.danger,
    noticeErrorText: colors.almostBlack,
...
export const buildDarkTheme = (input: Partial<Colors>): DefaultTheme => {
  ...
  return {
    ...
    noticeQuestionText: colors.white,
    noticeErrorText: colors.white,
